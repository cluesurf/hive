 ...
 * These are pure mathematical transformations between model representations.
 */

// =============================================================================
// Hyperbolic Model Projections
// =============================================================================
 ...
 */
export function stereographicToSphere(
  point: [number, number],
  out?: Point,
): Point {
  const u = point[0]
